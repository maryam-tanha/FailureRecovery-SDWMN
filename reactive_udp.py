...
class Reactive_Recovery(app_manager.RyuApp):
    ...
    _CONTEXTS = {
       ...
       # "monitor": network_monitor2.network_monitor,
    }
...
#            datapath_first.send_msg(out)
    ...
    def _packet_in_handler(self, ev):
        ...
        if isinstance(ip_pkt, ipv4.ipv4):
            ...
            if src_sw != None and dst_sw != None:
                #paths = self.k_shortest_paths(self.G,src_sw, dst_sw,2 , weight="weight")
                #self.G = self.network_aware.G
    ...
    def link_del_handler(self, ev):
         ...
         if removed_link is not None:
                        ...
                        self.logger.info("Affected flows are %s\n", affected_flows)
